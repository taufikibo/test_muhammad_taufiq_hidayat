...
<div class="jumbotron">
  ...
  <a href="<?php echo base_url() ?>books/add">add books</a>
...
$(document).ready(function () {
    ...
    $('#example').DataTable( {
		...
		"processing": true,
            "bServerSide": false,
            "sAjaxSource": '<?php echo base_url();?>books/get_books',
            "sServerMethod": "GET",
            ...
            "render": function ( data, type, row, meta ) {
                var id = row[0];                    
                return '<a href="<?php echo base_url();?>books/edit_books/' + id + '">Edit</a> '+
				' | '+
				<?php if($this->session->userdata('role')=='admin'){ ?>
				'<a href="<?php echo base_url();?>books/delete_books/' + id + '">Delete</a>'
				<?php }else{?>
